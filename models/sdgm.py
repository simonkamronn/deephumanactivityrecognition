...
class SDGM(Model):
    """
    The :class:'SDGM' class represents the implementation of the model described in the
    ...
    def __init__(self, n_x, n_a, n_z, n_y, qa_hid, qz_hid, qy_hid, px_hid, pa_hid, nonlinearity=rectify,
        ...
        """
        super(SDGM, self).__init__(n_x, qz_hid + px_hid, n_a + n_z, nonlinearity)
        self.x_dist = x_dist
        self.n_y = n_y
        self.n_x = n_x
        self.n_a = n_a
    ...
    def build_model(self, train_set_unlabeled, train_set_labeled, test_set, validation_set=None):
        ...
        """
        super(SDGM, self).build_model(train_set_unlabeled, test_set, validation_set)

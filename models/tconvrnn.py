...
class tconvRNN(Model):
    def __init__(self, n_in, n_hidden, n_out, n_filters, filter_sizes, pool_sizes, stats=2,
                 ...
                 conv_dropout=0.0, rnn_in_dropout=0.0, rnn_hid_dropout=0.0, output_dropout=0.0, conv_stride=1):
        ...
        self.l_in = InputLayer(shape=(None, sequence_length+stats, n_features))
        l_prev = self.l_in
    ...
    def build_model(self, train_set, test_set, validation_set=None):
        super(tconvRNN, self).build_model(train_set, test_set, validation_set)
